...
import { listMedia, getHealth } from "@/lib/api";
...
export default function DashboardPage() {
  // Fetch recent uploads via listMedia API
  const { data: mediaData, isLoading: recentLoading } = useQuery({
  ...
  return (
    <>
      ...
      {/* Recent Uploads */}
      <div className="mb-8">
        {/* We map items to SearchResult format for the component compatibility */}
        <RecentUploads
          items={
